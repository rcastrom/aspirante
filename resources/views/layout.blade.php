...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Aspirante ingresar</span>
            </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
            <a href="#"><i class="fa fa-info-circle"></i> <span>Información</span>
              <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
              <!--<li><a href="/ficha/convocatoria/">Convocatoria</a></li> -->
              <li><a href="https://sites.google.com/ite.edu.mx/guia/p%C3%A1gina-principal">Guía para el examen de admisión</a></li>
              <!--<li><a href="/ficha/requisitos/">Requisitos para inscripción</a></li> -->
            </ul>
          </li>
        <li class="treeview">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2019 <a href="https://www.ensenada.tecnm.mx">Instituto Tecnológico de Ensenada</a>.</strong>
  </footer>
