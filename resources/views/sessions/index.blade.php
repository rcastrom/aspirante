          ...
          <div class="masthead-content text-white py-5 py-md-0">
            ...
            <ul class="nav flex-column">
                @if (Route::has('login'))
                    @auth
                        <li class="nav-item">
                            <a href="/ficha"><i class="fas fa-ad">Obtener ficha</a></i>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('logout') }}"><i class="fas fa-user-logout">Salir</a></i>
                        </li>
                    @else
                        <li class="nav-item">
                            <a href="{{ route('login') }}"><i class="fas fa-sign-in-alt">Ingresar</a></i>
                        </li>
                    @endauth
                @endif
                <!--<li class="nav-item">
